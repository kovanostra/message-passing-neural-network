...
export MODEL_DIRECTORY='model_checkpoints/configuration&id__model&RNN__epochs&400__loss_function&MSE__optimizer&Adagrad__batch_size&40__maximum_number_of_features&-1__maximum_number_of_nodes&-1__validation_split&0.2__test_split&0.1__time_steps&1__validation_period&40/Epoch_400_model_state_dictionary.pth'
